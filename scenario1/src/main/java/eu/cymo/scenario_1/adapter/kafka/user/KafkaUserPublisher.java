...
import eu.cymo.scenario_1.adapter.kafka.ProducerRecordBuilder;
import eu.cymo.scenario_1.domain.user.PublishUserEventException;
import eu.cymo.scenario_1.domain.user.User;
import eu.cymo.scenario_1.domain.user.UserPublisher;
import eu.cymo.scenario_1.domain.user.UserValidated;
