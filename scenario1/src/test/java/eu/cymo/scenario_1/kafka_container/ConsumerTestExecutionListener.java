...
import eu.cymo.scenario_1.utils.FieldSerdes;
import eu.cymo.scenario_1.utils.Fields;
...
public class ConsumerTestExecutionListener implements TestExecutionListener {
	...
	private Consumer<?, ?> createConsumer(Field field, TestContext testContext) {
		var consumer = new KafkaConsumer<>(
				...
				FieldSerdes.getKeySerde(field).deserializer(),
				FieldSerdes.getValueSerde(field).deserializer());
