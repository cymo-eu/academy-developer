package eu.cymo.scenario_4.kafka_topology;
...
import eu.cymo.scenario_4.adapter.kafka.KafkaConfiguration;
import eu.cymo.scenario_4.adapter.kafka.KafkaPropertiesAvroSerdeFactory;
