package eu.cymo.scenario_8.kafka_topology;
...
import eu.cymo.scenario_8.adapter.kafka.KafkaConfiguration;
import eu.cymo.scenario_8.adapter.kafka.KafkaPropertiesAvroSerdeFactory;
